# 🚀 RFC-002: Reactless State, Effects, and Dynamic Features Integration
...
Reactless reintroduces the concept of **Dynamic Islands** (similar to **Dyanmic Islands** in Deno Fresh) - isolated regions within static templates that can react to state and props changes.
